...
public class GenerateTuples {
    ...
    public GenerateTuples(String tableName, int total)
    {
        ...
        descriptions = new String[]{"Analysis of Body Flu", "Biopsy", "Endoscopy", "Genetic Testing", "Imaging", "Measurement of Body"};
        this.total = total;
    ...
    public void generate()
    {
            ...
            Log.i("CREATE", "CREATE TABLE " + tableName + " (noteid INT, patientfirstname STRING, patientlastname STRING, doctorfirstname STRING, doctorlastname STRING, description STRING, p_date_time TIMESTAMP, heartrate INT);");
            getTuples();
    }
    ...
    {
        return "'" + firstNames[(int)(Math.random() * 499)] + "'";

    }

    private String generateLastName()
    {
        return "'" + lastNames[(int)(Math.random() * 499)] + "'";
    }
    ...
    {
        return "'" + descriptions[(int)(Math.random() * 5)] + "'";
    }
    ...
    private String generateDate()
    {
        ...
        return "'" + gc.get(gc.YEAR) + "-" + (gc.get(gc.MONTH) + 1) + "-" + gc.get(gc.DAY_OF_MONTH) + " " + String.valueOf(hours) + ":" + String.valueOf(minutes) + ":" + "00'";
    }
