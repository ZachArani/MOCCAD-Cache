...
public class CloudDataAccessProvider implements DataAccessProvider{
    ...
    private String mURLBase = "http://172.27.232.81:8080/CloudWebService/rest/";
	...
	public CloudDataAccessProvider(Context context) throws DownloadDataException, JSONParserException
	{
		...
		String ipAddress = pref.getString(PREF_IP_ADDRESS,"172.27.232.81"); //school is 10.204.69.210, Jason home is 192.168.0.132 - change in two places here, and in preferences.xml in cacheprototypeapp
